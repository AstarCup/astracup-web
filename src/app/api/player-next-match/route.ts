...
import { getPlayerMatchups, getUser } from "@/lib/prisma-registrations";
  ...
  try {
    ...
    const userMatchups = allMatchups.filter(
      (matchup) =>
        ...
        matchup.player2_osuId === userOsuId,
    );
    ...
    // 获取对手信息
    const opponentOsuId =
      availableMatchup.player1_osuId === userOsuId
        ? availableMatchup.player2_osuId
        : availableMatchup.player1_osuId;

    const opponentUser = await getUser(opponentOsuId);
      ...
      nextMatch: {
        ...
        opponent: {
          ...
          username:
            ...
            (availableMatchup.player1_osuId === userOsuId
              ? availableMatchup.player2_username
              : availableMatchup.player1_username),
