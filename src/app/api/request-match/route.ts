...
import { createMessage, getPlayerMatchups, updatePlayerMatchupStatus, createMatchSchedule, getMatchRooms } from '@/lib/mysql-registrations';
...
export async function POST(request: NextRequest) {
    try {
        ...
        const scheduleId = await createMatchSchedule({
            ...
            red_player_osuId: undefined,
            blue_player_osuId: undefined,
            red_score: 0,
            blue_score: 0,
            status: 'pending',
