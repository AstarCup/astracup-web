...
import {
  ...
  createStaffRoomAssignment,
  deleteStaffRoomAssignment,
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { room_id, staff_osuId, staff_username, staff_role, assigned_by } =
      body;
    ...
    const existingApplication = existingAssignments.find(
      (a) => a.staff_osuId === staff_osuId && a.role === staff_role,
    );
