              ...
              {matchSchedules.map((schedule) => (
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span
                      className={`px-2 py-1 rounded text-xs ${getStatusColor(schedule.status)} text-white`}
                    >
                  ...
                  <div className="text-xs text-gray-400 space-y-1 mb-3">
                    <div>
                      轮次: {schedule.room?.round_number} | 场次:{" "}
                    ...
                    {schedule.room?.match_date && schedule.room?.match_time && (
                      <div>
                        时间:{" "}
                        {formatDateTime(
                          schedule.room.match_date,
                          schedule.room.match_time,
                        )}
                      </div>
                    )}
                  </div>
            ...
            <div className="space-y-4">
                ...
                >
                  ...
                  {matchRooms.map((room) => (
                    <option key={room.id} value={room.id}>
                      {room.room_name} (轮次 {room.round_number}, 场次{" "}
                      {room.match_number})
                    </option>
                  ))}
                </select>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-400 text-sm">
                            {player1Info.country_code} •{" "}
                            {player1Info.pp.toFixed(0)}pp
                            {player1Info.global_rank &&
                              ` • #${player1Info.global_rank}`}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="bg-[#2a2a2a] p-3 rounded-md border border-gray-600">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-400 text-sm">
                            {player2Info.country_code} •{" "}
                            {player2Info.pp.toFixed(0)}pp
                            {player2Info.global_rank &&
                              ` • #${player2Info.global_rank}`}
                          </p>
                        </div>
                      </div>
              ...
              <div className="flex space-x-2 pt-4">
                <button
                  ...
                  disabled={
                    creating || !selectedRoomId || !player1Info || !player2Info
                  }
