            ...
            <div className="space-y-3">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    const selectedPlayer = approvedPlayers.find(
                      (p) => p.osuId === e.target.value,
                    );
                    if (selectedPlayer) {
                      setFormData({
                        ...formData,
...
export default function MatchupManagement({
  matchups,
  matchupsLoading,
  deletingMatchupId,
  approvedPlayers,
              ...
              >
                ...
                <div className="mt-3 pt-3 border-t border-gray-600">
                  ...
                  <div className="mt-2 text-xs text-gray-500">
                    创建时间:{" "}
                    {new Date(matchup.created_at).toLocaleString("zh-CN")}
                  </div>
                </div>
              </div>
            ))}
