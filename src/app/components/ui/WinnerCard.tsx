  ...
  return (
    <>
      ...
      >
        {/* 排名徽章 */}
        <div
          className={`absolute -top-4 -right-4 w-12 h-12 bg-gradient-to-br ${rankStyle.bgGradient} rounded-full flex items-center justify-center border-4 border-[#1A1A1A] shadow-lg`}
        >
        ...
        <div className="text-center mb-6">
          ...
          <div className="text-gray-400 text-sm">{seasonName}</div>
        </div>
