      ...
      <article>
        ...
        >
          <div className="flex flex-row">
            ...
            <h1
              className="text-4xl md:text-5xl font-bold text-gray-600 leading-tight m-0 pl-6 relative"
          ...
          <p
            className="text-gray-600 text-base md:text-lg md:ml-6 mb-1 md:mb-0"
            style={{ zIndex: 2 }}
          >
