...
export default function MatchSettings({
  ...
  const [manualNextTeam, setManualNextTeam] = useState<"red" | "blue" | null>(
    null,
  );
    ...
    const checkOBSConnection = () => {
      ...
      if (isConnected && window.obsstudio) {
        ...
        try {
          if (
            obs.getCurrentScene &&
            typeof obs.getCurrentScene === "function"
          ) {
  ...
  // 场景映射配置处理
  const handleSceneMappingChange = (
    type: "main" | "mapPool" | "victory",
    sceneName: string,
  ) => {
    setObsState((prev) => ({
      ...prev,
    ...
    const savedMappings = JSON.parse(
      localStorage.getItem("obsSceneMappings") || "{}",
    );
  ...
  const handlePlayerDropdownChange = (
    team: "red" | "blue",
    playerId: string,
  ) => {
  ...
  // 裁判表功能函数
  const handleScoreChangeWithHistory = (
    teamId: "red" | "blue",
    newScore: number,
  ) => {
  ...
  const generateRefereeText = () => {
    ...
    if (nextAction && nextTeam) {
      const nextPlayerName =
        nextTeam === "red" ? redTeam?.playerName : blueTeam?.playerName;
  ...
  const generateMatchInfo = () => {
    ...
    const category = mapPoolSettings.category
      ? mapPoolSettings.category.toUpperCase()
      : "RO16";
    ...
    <div className="">
      ...
      <div className="flex mb-6 border-b border-gray-600">
        <button
          ...
          className={`px-4 py-2 text-2xl font-medium transition-colors ${
            activeTab === "match"
      ...
      {activeTab === "match" ? (
        <>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-3">
              <label className="text-4xl text-gray-200 font-medium">
                比赛信息
              </label>
              <button
                onClick={() =>
                  copyResultText(generateMatchInfo(), "match-info")
                }
                className={`px-4 py-2 text-white rounded text-2xl transition-colors ${
                  copiedStates["match-info"]
            ...
            <div className="bg-gray-700/50 p-4 rounded">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div className="flex flex-col">
                  <label className="text-2xl text-gray-200 mb-2 font-medium">
                    比赛编号
                  </label>
                  <input
                    type="text"
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center h-full">
                <button
                  ...
                  className={`px-6 py-3 rounded-lg text-2xl font-bold transition-colors ${
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-6 p-4 rounded-lg bg-gray-700/50">
            ...
            <div className="flex flex-col">
              <label
                className="text-2xl text-gray-200 mb-2 font-medium"
                style={{ color: getTeamColor("red") }}
              >
                红队货币
              </label>
              <input
                ...
                onChange={(e) =>
                  onSettingsChange({
                    ...settings,
                    redCurrency: parseInt(e.target.value) || 0,
                  })
                }
                className="w-full bg-[#2D2D2D] text-white border border-gray-600 rounded px-3 py-2 focus:outline-none focus:border-[#E93B66] transition-colors text-2xl"
                placeholder="红队货币值"
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={(e) =>
                  onSettingsChange({
                    ...settings,
                    blueCurrency: parseInt(e.target.value) || 0,
                  })
                }
          ...
          {settings.matchMode === "teamvs" ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6 p-4 rounded-lg bg-gray-700/50">
              <div className="flex flex-col">
                ...
                />
                <label
                  className="text-2xl text-gray-200 mb-2 font-medium mt-4"
                  style={{ color: getTeamColor("red") }}
                >
                  红队头像URL
                </label>
                <input
                  ...
                  onChange={(e) =>
                    onSettingsChange({
                      ...settings,
                      redTeamAvatarUrl: e.target.value,
                    })
                  }
                  className="w-full bg-[#2D2D2D] text-white border border-gray-600 rounded px-3 py-2 focus:outline-none focus:border-[#E93B66] transition-colors text-2xl"
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onSettingsChange({
                      ...settings,
                      blueTeamAvatarUrl: e.target.value,
                    })
                  }
                  className="w-full bg-[#2D2D2D] text-white border border-gray-600 rounded px-3 py-2 focus:outline-none focus:border-[#3b5be9ff] transition-colors text-2xl"
              ...
              <div className="flex flex-col">
                ...
                <div className="flex gap-3 text-2xl">
                  <Dropdown
                    ...
                    onChange={(value) =>
                      handlePlayerDropdownChange("red", value)
                    }
              ...
              <div className="flex flex-col">
                ...
                <div className="flex gap-3">
                  <Dropdown
                    ...
                    onChange={(value) =>
                      handlePlayerDropdownChange("blue", value)
                    }
          ...
          <div className="bg-gray-700/50 p-4 rounded-lg">
            <label className="text-2xl text-gray-200 mb-3 font-medium">
              OBS场景控制
            </label>
            <div className="text-gray-300 text-xl mb-4">
              <div className="flex items-center gap-2">
                <div
                  className={`w-3 h-3 rounded-full ${window.obsstudio ? "bg-green-500" : "bg-red-500"}`}
                ></div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="flex flex-col">
                ...
                <Dropdown
                  ...
                  onChange={(value) =>
                    handleSceneMappingChange("mapPool", value)
                  }
                  darkMode={true}
                  minWidth="15rem"
                  fontSize={"text-xl"}
              ...
              <div className="flex flex-col">
                ...
                <Dropdown
                  ...
                  onChange={(value) =>
                    handleSceneMappingChange("victory", value)
                  }
                  darkMode={true}
                  minWidth="15rem"
                  fontSize={"text-xl"}
              ...
              <button
                ...
                onClick={() => {
                  if (
                    ...
                    typeof window.obsstudio.getScenes === "function"
                  ) {
                    ...
                    alert(
                      "OBS未连接或API不可用，请在OBS浏览器源中启用访问权限",
                    );
                  }
                }}
              >
              ...
              <button
                ...
                onClick={() => {
                  if (
                    ...
                    typeof window.obsstudio.getCurrentScene === "function"
                  ) {
                    window.obsstudio.getCurrentScene(
                      (scene: { name: string }) => {
        ...
        <div className="space-y-6">
          <div className="text-center">
            <div className="text-3xl text-gray-200 mb-4">
              当前计时: {timerState.remainingTime}秒
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              onClick={toggleTimer}
              className={`px-6 py-4 rounded text-5xl transition-colors font-bold ${
        ...
        <div className="space-y-6">
          <div className="flex gap-4">
            ...
            <div className="flex justify-center">
              <button
                ...
                className={`px-8 py-6 rounded-lg text-3xl font-bold transition-colors ${
                  rollState.isRolling
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-3">
              <label className="text-2xl text-gray-200 font-medium">
                Roll点历史记录
              </label>
              {rollState.history.length > 0 && (
                <button
              ...
              {rollState.history.length === 0 ? (
                ...
                rollState.history
                  ...
                  .map((record, index) => (
                    <div
                      key={index}
                      className="text-white text-6xl mb-3 p-3 bg-gray-600/30 rounded"
                    >
                      ...
                      <div className="flex">
                        ...
                        <button
                          ...
                          className={`px-3 py-1 text-white text-5xl transition-colors ${
                            copiedStates[`record-${record.timestamp}`]
                              ? "bg-green-600 hover:bg-green-700"
                              : "bg-blue-600 hover:bg-blue-700"
                          }`}
                        >
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-6 mb-6">
            {/* 当前操作队伍 */}
            <div className="flex flex-col">
              <label className="text-4xl text-gray-200 mb-3 font-medium">
                当前操作队伍
              </label>
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 px-4 py-3 rounded-lg text-4xl font-bold transition-colors ${
                    banPickState.currentTeam === "red"
            ...
            <div className="flex flex-col">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 px-4 py-3 rounded-lg text-4xl font-bold transition-colors ${
                    banPickState.currentAction === "ban"
                      ? "bg-red-600 text-white"
                      : "bg-gray-700 text-gray-300 hover:bg-gray-600"
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 px-4 py-3 rounded-lg text-4xl font-bold transition-colors ${
                    banPickState.currentAction === "pick"
                      ? "bg-blue-600 text-white"
                      : "bg-gray-700 text-gray-300 hover:bg-gray-600"
                  }`}
                >
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            ...
            <div className="flex flex-col">
              <label
                className="text-4xl text-gray-200 mb-3 font-medium"
                style={{ color: getTeamColor("red") }}
              >
                红队分数
              </label>
              <div className="flex gap-2">
                <button
                  onClick={() =>
                    handleScoreChangeWithHistory(
                      "red",
                      (teams.find((t) => t.id === "red")?.score || 0) - 1,
                    )
                  }
              ...
              <div className="flex gap-2">
                <button
                  onClick={() =>
                    handleScoreChangeWithHistory(
                      "blue",
                      (teams.find((t) => t.id === "blue")?.score || 0) - 1,
                    )
                  }
              ...
              <div className="flex gap-2 mb-2">
                <button
                  onClick={() =>
                    onSettingsChange({
                      ...settings,
                      redCurrency: Math.max(0, settings.redCurrency - 150),
                    })
                  }
                ...
                <button
                  onClick={() =>
                    onSettingsChange({
                      ...settings,
                      redCurrency: Math.max(0, settings.redCurrency - 100),
                    })
                  }
                ...
                <button
                  onClick={() =>
                    onSettingsChange({
                      ...settings,
                      redCurrency: Math.max(0, settings.redCurrency - 50),
                    })
                  }
              ...
              <div className="flex gap-2">
                <button
                  onClick={() =>
                    onSettingsChange({
                      ...settings,
                      redCurrency: settings.redCurrency + 50,
                    })
                  }
                  className="flex-1 px-4 py-3 bg-red-500 hover:bg-red-600 text-white rounded text-2xl font-bold transition-colors"
                >
                ...
                <button
                  onClick={() =>
                    onSettingsChange({
                      ...settings,
                      redCurrency: settings.redCurrency + 100,
                    })
                  }
                  className="flex-1 px-4 py-3 bg-red-600 hover:bg-red-700 text-white rounded text-2xl font-bold transition-colors"
                >
                ...
                <button
                  onClick={() =>
                    onSettingsChange({
                      ...settings,
                      redCurrency: settings.redCurrency + 150,
                    })
                  }
                  className="flex-1 px-4 py-3 bg-red-700 hover:bg-red-800 text-white rounded text-2xl font-bold transition-colors"
                >
              ...
              <div className="flex gap-2 mb-2">
                <button
                  onClick={() =>
                    onSettingsChange({
                      ...settings,
                      blueCurrency: Math.max(0, settings.blueCurrency - 150),
                    })
                  }
                ...
                <button
                  onClick={() =>
                    onSettingsChange({
                      ...settings,
                      blueCurrency: Math.max(0, settings.blueCurrency - 100),
                    })
                  }
                ...
                <button
                  onClick={() =>
                    onSettingsChange({
                      ...settings,
                      blueCurrency: Math.max(0, settings.blueCurrency - 50),
                    })
                  }
              ...
              <div className="flex gap-2">
                <button
                  onClick={() =>
                    onSettingsChange({
                      ...settings,
                      blueCurrency: settings.blueCurrency + 50,
                    })
                  }
                  className="flex-1 px-4 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded text-2xl font-bold transition-colors"
                >
                ...
                <button
                  onClick={() =>
                    onSettingsChange({
                      ...settings,
                      blueCurrency: settings.blueCurrency + 100,
                    })
                  }
                  className="flex-1 px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded text-2xl font-bold transition-colors"
                >
                ...
                <button
                  onClick={() =>
                    onSettingsChange({
                      ...settings,
                      blueCurrency: settings.blueCurrency + 150,
                    })
                  }
                  className="flex-1 px-4 py-3 bg-blue-700 hover:bg-blue-800 text-white rounded text-2xl font-bold transition-colors"
                >
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-3">
              ...
              <button
                onClick={() =>
                  copyResultText(refereeDisplayText, "referee-text")
                }
                className={`px-4 py-2 text-white rounded text-4xl transition-colors ${
                  copiedStates["referee-text"]
                    ? "bg-green-600 hover:bg-green-700"
                    : "bg-blue-600 hover:bg-blue-700"
                }`}
              >
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex-1 px-4 py-3 rounded-lg text-2xl font-bold transition-colors ${
                  manualNextTeam === "red"
                    ? "bg-red-600 text-white"
                    : "bg-gray-700 text-gray-300 hover:bg-gray-600"
                }`}
                ...
                banPickState.history
                  ...
                  .map((record, index) => (
                    <div key={index} className="text-white text-4xl mb-2">
                      ...
                      <span className="text-gray-300">{record.modSlot}</span>
                    </div>
                  ))
              )}
            </div>
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-700/50 p-4 rounded max-h-48 overflow-y-auto">
              {refereeState.history.length === 0 ? (
                ...
                refereeState.history
                  .slice()
                  .reverse()
                  .map((record, index) => (
                    <div
                      key={index}
                      className="text-white text-4xl mb-3 p-3 bg-gray-600/30 rounded"
                    >
                      <div className="flex justify-between items-center mb-2">
                        <span
                          className={
                      ...
                      <div className="text-gray-300">{record.content}</div>
                    </div>
                  ))
              )}
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="text-center">
            <div className="text-3xl text-gray-200 mb-4">
              当前状态:{" "}
              {victoryState.isVisible ? "显示胜利页面" : "隐藏胜利页面"}
            </div>
            {victoryState.winner && (
              <div className="text-xl text-gray-400">
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-3">
              ...
              <button
                onClick={() =>
                  copyResultText(generateVictoryText(), "victory-text")
                }
                className={`px-4 py-2 text-white rounded text-4xl transition-colors ${
                  copiedStates["victory-text"]
                    ? "bg-green-600 hover:bg-green-700"
                    : "bg-blue-600 hover:bg-blue-700"
                }`}
              >
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-6 mb-6">
            {/* 赛季选择 */}
            <div className="flex flex-col">
              <label className="text-4xl text-gray-200 mb-2 font-medium">
                赛季
              </label>
              <Dropdown
                options={
                ...
                onChange={(value) =>
                  onMapPoolSettingsChange({ ...mapPoolSettings, season: value })
                }
                darkMode={true}
                minWidth="25rem"
                fontSize={"text-4xl"}
