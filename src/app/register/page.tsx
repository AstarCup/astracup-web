    ...
    <div className="min-h-screen py-12">
      <div className="max-w-2xl mx-auto p-8">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-100">请使用您的 osu! 账号登录</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="text-center">
            <button
              ...
              disabled={isLoading}
              className={`px-8 py-4  text-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#FF66AA] ${
                !isLoading
