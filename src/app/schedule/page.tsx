...
import type { MatchSchedule, StaffRoomAssignment } from "@prisma/client";
...
export default function Schedule() {
  ...
  const fetchMatchSchedules = async () => {
    try {
      setLoading(true);
      const [matchSchedulesResponse, staffAssignmentsResponse] =
        await Promise.all([
  ...
  // 从match_link中提取房间号
  const extractRoomIdFromMatchLink = (
    matchLink: string | undefined,
  ): string | null => {
  ...
  return (
    <div className="max-w-9xl mx-auto p-6">
      ...
      <div className="mb-8">
        ...
        <button
          onClick={() =>
            (window.location.href = "/multiplayer-scores?room=1774254")
          }
